...
variable "image_mount_path" {
  type    = string
  default = "/mnt/packer-chroot/cloud-init"
}
...
source "arm" "autogenerated_1" {
  ...
  file_urls             = ["file:///images/base.tar.gz"]
...
build {
  ...
  provisioner "ansible" {
    ...
    inventory_file   = "./cloud-init/ansible/hosts"
    playbook_file    = "./cloud-init/ansible/site.yml"
  }
